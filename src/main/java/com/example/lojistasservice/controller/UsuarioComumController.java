...
public class UsuarioComumController {
    ...
    public UsuarioComumResponseDTO inserirSaldo(@RequestBody final UsuarioComumRequestDTO resquestDTO) {
        val usuarioComum = UsuarioComumMapper.toDomain(resquestDTO);
        val savedUsuarioComum = gateway.save(usuarioComum);
        val usuarioComumResponseDTO = UsuarioComumMapper.toDto(savedUsuarioComum);
